...
class router_tb extends uvm_env;
  ...
  virtual function void connect_phase(uvm_phase phase);
    ...
    //TLM Connections
    yapp.tx_agent.monitor.yapp_port.connect(router_env.router_ref.imp_yapp);
    hb_env.masters[0].monitor.item_collected_port.connect(router_env.router_ref.imp_hbus);
    chan0.rx_agent.monitor.item_collected_port.connect(router_env.scbd.ch0_port);
    chan1.rx_agent.monitor.item_collected_port.connect(router_env.scbd.ch1_port);
    chan2.rx_agent.monitor.item_collected_port.connect(router_env.scbd.ch2_port);
