...
class router_tb extends uvm_env;
  ...
  virtual function void connect_phase(uvm_phase phase);
    ...
    //TLM Connections
    yapp.tx_agent.monitor.yapp_port.connect(scbd.yapp_port);
    chan0.rx_agent.monitor.item_collected_port.connect(scbd.ch0_port);
    chan1.rx_agent.monitor.item_collected_port.connect(scbd.ch1_port);
    chan2.rx_agent.monitor.item_collected_port.connect(scbd.ch2_port);
